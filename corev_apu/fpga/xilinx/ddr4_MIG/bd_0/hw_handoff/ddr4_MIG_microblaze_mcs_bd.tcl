...
################################################################
# This is a generated script based on design: bd_178f
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./project_1/project_1.srcs/sources_1/ip/ddr4_MIG/bd_0
